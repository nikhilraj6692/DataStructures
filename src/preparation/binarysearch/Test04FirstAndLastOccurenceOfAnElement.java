...
public class Test04FirstAndLastOccurenceOfAnElement
{
    ...
    /*
    in this algo, there is a chance that even after meeting the elem at mid pos, we can find more
     elements at the left (end = mid -1)
    for first occurrence and we can find more elements at the right ( start = mid + 1) for last
    occurrence
     */
