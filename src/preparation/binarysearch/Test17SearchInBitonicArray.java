...
/*
Find peak element as test16findmaxinbitonicarray. this your pivot. cut it into two sub arrays and
 find the element. one with
sorted subarray(test01) and other wth sorted subarray in decreasing order(test02) and the last
one is pivot itself
 */
