...
/*
we have to find the index in the array for which the difference between array value at a given
index and the key is minimum...
just find the nearest number to the given number, i.e. find the floor and its index. Similarly
find ceil and find diff of ceil with
...
public class Test14FindMinimumDifferenceElementInASortedArray
{
    ...
    /*
    another way is to just do a normal binary search. low and high would be floor and ceil or
    vice versa
     */
    ...
    {
        int floorIndex = Test09FloorOfAnElementInASortedArray.floorSearchSimpler(arr, 0,
            arr.length - 1, key);
