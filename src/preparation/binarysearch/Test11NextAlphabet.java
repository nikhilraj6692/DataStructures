...
/*
no difference than test10ceilofanelementinasortedarray. the only difference is that here the
array is alphaber rather than numbers.
The best way is to create an array of numbers with ascii number of alphabet - 'a', find ceil of
the number and then again convert
into alphabet
 */
