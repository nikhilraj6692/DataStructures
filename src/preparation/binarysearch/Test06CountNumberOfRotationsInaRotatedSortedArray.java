...
public class Test06CountNumberOfRotationsInaRotatedSortedArray
{
    ...
    //{15, 18, 19, 20, 2, 3};
    /*
    in this also we have to check if mid is less than prev and next. If yes, then the element
    before it is not sorted and the index
    is the answer. but we check that if start <= mid then surely left is sorted, we have to go to
