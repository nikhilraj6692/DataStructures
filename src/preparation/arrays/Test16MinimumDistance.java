...
NOTE: This question is intentionally left slightly vague. Clarify the question by trying out a
few cases in the “See Expected Output” section.
...
Explanation 1:
 ...
 It takes 1 step to move from (0, 0) to (1, 1). It takes one more step to move from (1, 1) to (1,
  2).
 */
public class Test16MinimumDistance
{
    ...
    /*
    Solution: If we think of a rectangle region between two points, then minimum distance to move
     from one point to other would
    be a diagonal from start point to the edge of rectangle region which would be min(x2-x1,
    y2-y1) and from that point to dest
