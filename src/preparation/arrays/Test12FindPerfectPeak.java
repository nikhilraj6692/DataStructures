...
public class Test12FindPerfectPeak
{
    ...
    {
        /*
        Solution: Find max to the left and min to the right of an element. If the element is
        greater than max and smaller than min,
        it is a perfect peak element.
         */
        System.out.println(perfectPeak(
            new int[]{9488, 25784, 5652, 9861, 31311, 8611, 1671, 7129, 28183, 2743, 11059, 4473,
                7927, 21287, 2259, 7214, 32529}));
    }
