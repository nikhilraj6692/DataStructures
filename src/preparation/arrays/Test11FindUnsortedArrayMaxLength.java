...
public class Test11FindUnsortedArrayMaxLength
{
    ...
    /*
    Solution 2: find element from left which is greater than its next element and find element from left which is smaller than its
    previous element. This will give us unsorted array. But note that this unsorted array can have some elements which is greater
    than an element in left sorted array and smaller than an element in right sorted array. this will expand the unsorted array length.
    ...
    /*
   Solution 1: Sort the array and compare original array with sorted array. find minimum and maximum unsorted index
    */
