...
public class Test07LongestSubstringWithoutRepeatingCharacters
{
    ...
    {
        String s = "thisisthelongeststring";
        System.out.println("The input String is " + s);
        int length = longestUniqueSubsttr(s);
        System.out.println(
            "The length of the longest non-repeating character substring is " + length);
    }

    /*
    same asbefore...the condition is with the value of current element. But it can also be done
    with map.size == j-i+1  and
    map.size < j-i+1
     */
