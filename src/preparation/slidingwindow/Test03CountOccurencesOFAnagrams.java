...
public class Test03CountOccurencesOFAnagrams
{
    ...
    /*
    the algorithm:
    first create a map of each character of pattern and maintain its count...now start checking
    like prev pattern. If value at
    j is not null, then decrement count(map.size()) and decrement the character count in map. go
    on till you hit window size.
    if count is equal to 0, meaning that you have hit all the characters. Now its turn to reverse
    . Increment for the character
