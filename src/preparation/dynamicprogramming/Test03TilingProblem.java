...
public class Test03TilingProblem {
    public static void main(String[] args) {
        /*
        If you have 2*m tiles board and you have to fill it by 2*1 tiles, then there are two ways to fill. think that if you fill the
        board with tiles vertically, then for each tile filled vertically remaining would be count(n-1) and if board is filled with
        tiles horizontally, then for each tile filled horizontally remaining would be count(n-2). For the base condition think like
