...
public class Test19MinimumNoOfDeletionInsertionToConvertStrtoAnotherStr
{
    ...
    public static void main(String[] args)
    {
        ...
        /*
        If we find lcs length, then the remaining character has to be inserted and deleted. Since
         we have to convert A to B, so from
    ...
    {
        int lcsLength = Test15LongestCommonSubSequence.lcsDP(str1.toCharArray(), str2.toCharArray(),
            str1.length(), str2.length());
        System.out.print(
            "Insertion :: " + (str2.length() - lcsLength) + " Deletion :: " + (str1.length()
                - lcsLength));
    }
}
