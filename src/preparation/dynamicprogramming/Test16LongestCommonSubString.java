...
/*
will be same as test15longestcommonsubsequence, but only thing is that if the two characters will
 not match, then we have to return 0
...
public class Test16LongestCommonSubString
{
    ...
    private static int LCSubStrRecursive(char[] toCharArray, char[] toCharArray1, int m, int n,
        int max)
    {
        if (m == 0 || n == 0)
        {
