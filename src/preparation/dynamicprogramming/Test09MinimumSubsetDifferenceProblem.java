...
public class Test09MinimumSubsetDifferenceProblem
{
    ...
    public static void main(String[] args)
    {
        ...
        /*
        a variant of subset sum problem only...but here we have to find out the subset such that
        abs(sum of subset1 - sum of subset2)
        is minimum, like here {3,4} and {1,2,2,1}, diff is 1 which is minimum. s1 + s2 = range,
        or s2 = range -s1. we have to find
        ...
        /*
        there is a way via dp, where we try to check only those elements in the last index of n
        corresponding to the half of the
