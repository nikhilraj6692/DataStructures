...
/*
In the problem, we have two travellers, one travels from top left and another travels from top
right. Both of them
have to pick up maximum coins in such a way that they can travel (i+1,j+1),(i+1,j) or (i+1,j-1).
One more condition
is that if both travellers are traversing same cell, then only one of them can pick coin in the
same cell.
 */
