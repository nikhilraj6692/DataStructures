...
/*
Find the maximum number of activities that can be solved by a person such that the person solves one activity at a 
time...in this problem, we can have max number of activities if we use the condition that the start time of an
...
public class Test37ActivitySelection {
    ...
    private static Set<Pair<Integer, Integer>> selectActivity(List<Pair<Integer, Integer>> activities) {
