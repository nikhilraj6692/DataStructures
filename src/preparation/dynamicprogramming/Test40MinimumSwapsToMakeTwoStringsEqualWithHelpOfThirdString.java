...
public class Test40MinimumSwapsToMakeTwoStringsEqualWithHelpOfThirdString {
    /*
    this is a very strange question for which we can only make two strings equal by swapping with third string.
    to solve this, we have to check char at a and char at b, if equal then move a and b pointer to right...
    however if not equal then check if char at a is equal to char at c or char at b is equal to c...if found any,
