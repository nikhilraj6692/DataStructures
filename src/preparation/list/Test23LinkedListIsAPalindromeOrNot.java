...
public class Test23LinkedListIsAPalindromeOrNot
{
    ...
    //find mid...if while fiding mid, odd is set to true, then mark mid to mid.next. Odd can be
    // set by checking if after while loop is covered,
    //still fastnode is null or not. If fast node is not null, then set odd to true. Then reverse
    // the mid and compare head and mid
