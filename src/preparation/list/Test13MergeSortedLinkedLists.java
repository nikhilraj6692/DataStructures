...
public class Test13MergeSortedLinkedLists
{
    ...
    /*
    iterate through first list and check if second list current node is smaller or greater. If
    smaller and prevNode==null, then
    attach second curr node to first curr node, else keep a track of prevNode each time and do
    same steps
     */
