...
/*
naive way is to iterate it once and keep it into a set or something and create a new list
iterating the set elements..
another way is to start iterating from head and do a while loop for the same node from its next
to end of the list and
keep swapping elements till you find that head data is greater than next data...like a bubble
sort...
