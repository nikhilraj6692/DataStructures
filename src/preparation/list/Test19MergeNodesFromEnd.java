...
/*
output should be 15 14 13 12 9 8 7 6 5 4...just we have to think like how we reverse a linked list...think of a new node,
whenever you see that one linked list data is smaller than the other in that case add this to new node and do the same
that you do in reverse....you have a prev node, new node.next = prev  and prev = newnode...here we don't have next as
