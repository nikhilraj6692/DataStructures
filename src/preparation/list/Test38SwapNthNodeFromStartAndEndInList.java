...
public class Test38SwapNthNodeFromStartAndEndInList
{
    ...
    //make use of function of n-m item from the list and keep a track of previous pointer of
    // start and end node and then swap
    //but extra care has to be taken when node to be swapped is first or last node or first.next
    // = last or last.next = first
