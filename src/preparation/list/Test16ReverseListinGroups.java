...
/*
important ques...if group size is 3 then 3 2 1 6 5 4 9 8 7...can be done via stack also where we
push k elements in
stack in a loop in which head!=null...and create a linked list from stack by peeking , linking
and then popping...for
...
public class Test16ReverseListinGroups
{
    ...
    //4->3->2->1->6->5->null
    /*
    it is maintaining a pair because with pair we will get to know that which node is the next
    starting node of linked
    list to be reversed...
     */
