...
Can be done by naive solution by iterating through the list, count the size of list and then
finally cut in half
good solution would be to traverse via slow and fast pointer and cut the node till slow pointer
and from slow pointer.next to end of the ode
 */
