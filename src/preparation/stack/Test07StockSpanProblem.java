...
/*
this problem says that you have to return the number of elements which is equal to or less than the number at the given index and
count such smaller number. ex: for 10, ans is 1, for 4 ans is 1, for 5 ans is 2 (4,5)....if we look closely it is a problem of
nearest greater to the left. We have to count all the numbers from the number at given index which are less OR in other words we have
