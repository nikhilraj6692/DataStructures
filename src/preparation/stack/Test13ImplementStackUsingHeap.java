...
/*
we are using priority queue to set priority of the last element in the stack as the maximum with count and reduce count whenever
...
class StackE{
    int count = 0;
    PriorityQueue<Pair<Integer, Integer>> q = new PriorityQueue<>((o1,o2)->o2.second.compareTo(o1.second));
