...
public class Test01FindMissingAndDuplicateNumberInArray {
    ...
    /*
    keep on swapping the element at index i with element at (element at index i-1) till the element at index i satisfies the cond.
    that element at i is equal to i+1. As soon as it is satisfied, increment i and do the same thing. once this is complete, traverse
    the array and the element, if not equal to i+1 is the repeated element and i+1 is the missing number
     */
