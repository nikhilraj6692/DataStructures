...
public class Test09DifferenceBetweenK1thSmallestAndK2thSmallest {
    ...
    /*
    one way is to sort the array and then find k1st smallest and k2nd smallest and find the sum of all numbers between them.
    second way is to either call two functions against both k and get max for both k. then traverse the array and check which is
    greater than first k and less than second k and find sum of all those numbers. third way is to fill max heap till largest of
