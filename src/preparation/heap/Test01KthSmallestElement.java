...
/*
if k is given and largest/smallest/greatest/top/closest/lowest/nearlysorted asked, then heap may be applied. if k largest then
minheap and k smallest then maxheap. complexity is nlogk. sorting is simple solution or naive solution for which time complexity is nlogn. in max heap, top is largest
