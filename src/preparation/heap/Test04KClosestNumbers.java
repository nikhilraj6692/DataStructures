...
public class Test04KClosestNumbers {
    public static void main(String[] args) {
        ...
        /*
        another solution is to do linear traversal and have a treemap so that the values can be sorted on value of map and then
        print k elements from the top
         */
    }

    /*
    in this algorithm, we have to find out n numbers which are close to x. So, basically we will have to create a max heap of
    differences along with their values...so we can create a pair here and remove the differences with priority queue sorted on
