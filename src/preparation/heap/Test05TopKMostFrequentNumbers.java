...
public class Test05TopKMostFrequentNumbers
{
    ...
    public static void main(String[] args)
    {
        ...
        /*
        another way to do is to have a map of frequent words and sort map on the basis of values
    ...
    /*
    same as closest numbers. difference is that here we will have second element as frequency.
    create a min heap as we have to
    ...
    private static void print_N_mostFrequentNumber(int[] arr, int n, int k)
    {
        ...
        PriorityQueue<Pair<Integer, Integer>> q = new PriorityQueue<>(
            Comparator.comparing(o -> o.second));
