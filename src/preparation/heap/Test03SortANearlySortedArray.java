...
public class Test03SortANearlySortedArray
{
    ...
    /*
    here k is the threshold which will help pop the element when the q size exceeds threshold.
    min heap selected because we want
    minimum at the top
     */
    ...
    /*
    by insertion sort. insertion sort is a sort in which we start from i as 1 and then have a j
    at i-1. Now continuously swap
