...
public class Test06FrequencyCount {
    ...
    /*
    one way is to create a map and then sort on the values...now iteratively based on the number of count print the element as many
    ...
    private static void sortBasedOnFrequencyAndValue(int[] arr) {
        ...
        PriorityQueue<Pair<Integer,Integer>> q = new PriorityQueue<>((o1,o2)->o2.second-o1.second);
        ...
        while(!q.isEmpty()){
            ...
            System.out.print(String.join(" ", Collections.nCopies(pair.second, String.valueOf(pair.first))) + " ");
        }
    }
}
