...
public class Test11CheckIfBinaryTreeIsASumTree
{
    ...
    private static float checkIfBinaryTreeIsASumTree(Node<Integer> root)
    {
        ...
        {
            return root.data / 2;
        } else if (checkIfBinaryTreeIsASumTree(root.left) + checkIfBinaryTreeIsASumTree(root.right)
            == root.data / 2)
        {
            return root.data;
        } else
    ...
    private static int checkIfBinaryTreeIsASumTree1(Node<Integer> root)
    {
        ...
        int sum =
            checkIfBinaryTreeIsASumTree1(root.left) + checkIfBinaryTreeIsASumTree1(root.right);
