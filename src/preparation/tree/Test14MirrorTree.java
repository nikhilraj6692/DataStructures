...
public class Test14MirrorTree {
    ...
    /*
    this way we are just rotating the nodes...but note that when we rotate the link reference gets changed in first
    call and it may lead to incorrect node for second call...so keep variables in temp as that the output comes right
     */
