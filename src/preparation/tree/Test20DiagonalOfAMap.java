...
public class Test20DiagonalOfAMap {
    public static void main(String[] args) {
        ...
        System.out.println(map.values().stream().mapToInt(x->x.data).boxed().collect(Collectors.toList()));
    }

    /*
    diagonal is like level...for right nodes, diagonal value would be same but for left, it would be diagonal + 1
    ...this recursive method can be used in level wise addition also.
     */
    private static void findDiagonalSum(Node<Integer> root, int diagonal, Map<Integer, Node<Integer>> map) {
