...
public class Test33MinimimzeCashFlowAmongFriends_SplitWise
{
    ...
    static void minCashFlow()
    {
        // Create an array amount[],
        // initialize all value in it as 0.
        /*
        use only below array in case graph is not involved...otherwise create an array of size N
         */
        int amount[]=new int[]{1000, 4000, -5000};
...
*/
    ...
    public static void main (String[] args)
    {
        ...
        /*
        in case graph is involved, uncomment this and solve compilation issue accordingly
         */
