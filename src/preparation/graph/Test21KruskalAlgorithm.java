...
public class Test21KruskalAlgorithm
{
    ...
    public static void main(String[] args)
    {
        ...
        /*
        In this algorithm, sort the edges on the basis of weight and then pick up each edge once,
         if it does not form a cycle,
        then consider the edge in MST. If the number of vertices is N, then edges in MST will be
        N-1. Since finding cycle using dfs
