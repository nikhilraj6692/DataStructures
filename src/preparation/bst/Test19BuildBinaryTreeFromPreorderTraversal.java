...
public class Test19BuildBinaryTreeFromPreorderTraversal {
    public static void main(String[] args) {
        ...
        root = buildTreeFromPreorderOptimizedWay(preorder, index, Integer.MIN_VALUE, Integer.MAX_VALUE);
        Test01InorderTraversal.inOrderTraversal(root);
    }

    public static Node<Integer> buildTreeFromPreorderOptimizedWay(int[] preorder, AtomicInteger index, int minValue, int maxValue) {
