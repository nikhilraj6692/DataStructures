...
public class Test23PrintCompleteBSTInIncreasingOrder {
    public static void main(String[] args) {
        ...
        //above array is a level order traversal of a complete bst. complete bst has two child nodes for each node
        //except leaf node

        //the concept is to mark left node of a node to be 2*index+1 th element and right node as 2*index+2 th element
