...
public class Test08FindPredecessorOfANodeInABST {
    public static void main(String[] args) {
        ...
        */
        ...
        for(Integer key: keys) {
            ...
            System.out.println("The predecessor of " + key + " is " + (null!=predecessor?predecessor.data: null));
        }
    ...
    /*
    if root data is equal to key then return the maximum from its left subtree if subtree is null. Otherwise return previous node
    For the right subtree there is an exceptional case, where we have to maintain prev node like in the case of 12
     */
    private static Node<Integer> findPredecessor(Node<Integer> root, int key, Node<Integer> prevNode) {
        if(root==null){
            return null;
        }
