...
public class Test11ConstructBSTFromTreeWithoutChangingStructure {
    public static void main(String[] args) {
        ...
        //first do inorder and create an ordered set and then replace the elements in the tree by iterating through the set
    ...
    private static void doInorderAndAddKeysToSetInAscendingOrder(Node<Integer> root, Set<Integer> set) {
        if(root == null)
            return;
