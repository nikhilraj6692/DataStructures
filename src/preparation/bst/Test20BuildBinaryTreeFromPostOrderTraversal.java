...
public class Test20BuildBinaryTreeFromPostOrderTraversal {
    public static void main(String[] args) {
        ...
        */
        ...
        root = buildTreeUsingPostOrderArrayOptimized(postorder, index, Integer.MIN_VALUE, Integer.MAX_VALUE);
        Test01InorderTraversal.inOrderTraversal(root);
    }

    private static Node<Integer> buildTreeUsingPostOrderArrayOptimized(int[] postorder, AtomicInteger index, int minValue, int maxValue) {
        if(index.get() == -1)
            return null;
