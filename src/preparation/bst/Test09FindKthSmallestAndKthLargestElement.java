...
public class Test09FindKthSmallestAndKthLargestElement
{
    ...
    private static int kthLargestRecursive(Node<Integer> root, int k, AtomicInteger nodeCount)
    {
        ...
        /*
        as soon as node is found, then return the node from right subtree..as we have to break,
    ...
    private static int kthSmallestRecursive(Node<Integer> root, int k, AtomicInteger nodeCount)
    {
        ...
        /*
        as soon as node is found, then return the node from left subtree..as we have to break, so
    ...
    /*
    this method takes extra space as list which has ordered data and then print kth smallest and
    largest element
     */
