...
public class Test17UpdateAllTheNodesWithSumOfGreaterNodes
{
    ...
    public static void main(String[] args)
    {
        ...
        */
        ...
        //2 3 4 5 6 8 10
        /*
        another technique can be to start from the rightest node (i.e. reverse inorder) and then
        keep on adding nodes in a variable
        and return that that variable. Add this variable to the root data. This will ensure that
