...
public class Test10FindCeilAndFloorOfAKey {
    public static void main(String[] args) {
        ...
        */
        ...
        for (int i = 1; i <= 15; i++) {
            ...
            System.out.println("Ceil of " + i + " is " + pair.first + " and floor of " + i + " is " + pair.second);
        }
    ...
    private static Pair<Integer, Integer> findFloorAndCeilRecursive(Node<Integer> root, int key, int ceil, int floor) {
        if(root == null){
