...
public class Test13FindPairInBSTWithGivenSum
{
    ...
    private static Pair<Integer, Integer> findSinglePairsWithGivenSumIterative(Node<Integer> root,
        int sum)
    {
        Set<Integer> set = new HashSet<>();
    ...
    private static Pair<Integer, Integer> findSinglePairsWithGivenSum(Node<Integer> root, int sum,
        Set<Integer> set)
    {
        if (root == null)
        {
    ...
    //[13, 18, 20, 16,  ]
    private static Pair<Integer, Integer> findAllPairsWithGivenSum(Node<Integer> root, int sum,
        Set<Integer> set, List<Pair<Integer, Integer>> allPairs)
    {
        if (null == root)
        {
            return Pair.of(-1, -1);
